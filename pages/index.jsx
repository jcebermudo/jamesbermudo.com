  ...
  return (
    <Layout>
      ...
      <p className="mt-6">
        ...
        I&apos;m currently running <a href="https://particles.work" className="hover:text-[#1281E1] underline">Particles</a>, a design studio for startups. When I&apos;m not working on that, you can catch me studying math and physics, tinker with new machine learning models, or practicing my sketching.
      </p>
      <div className="mt-16">
        {posts.map((post) => (
          <PostLink
