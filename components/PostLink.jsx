      ...
      <Link href="blog/[slug]" as={`blog/${slug}`}>
        ...
        <div className="group sm:grid sm:grid-cols-3 py-7 px-2 duration-150 hover:bg-[#f7f7f7]">
          <div className="mb-4 sm:mb-0">
            <p className="text-[#A1A1A1] text-left cursor-[url(/cursors/cursor-pointer.cur),_pointer]">{date}</p>
          </div>
          <div className="sm:col-span-2">
            <h3 className="text-[#333333] font-bold duration-150 group-hover:text-[#19A1FD] visited:text-[#a0a0a0] user-select-none">
              {title}
            </h3>
            <p className="text-[#575757] mt-3 cursor-[url(/cursors/cursor-pointer.cur),_pointer]">{description}</p>
          </div>
        </div>
