      ...
      <div className="flex flex-col items-center justify-center gap-[10px] max-w-[450px] w-full">
        ...
        >
          ...
          >
            ...
            >
              <Image
                className="absolute top-0 left-0 -translate-x-[19px] -translate-y-[5px] select-none rounded-[10px] z-[20]"
          ...
          >
            ...
            >
              <Image
                className="absolute top-0 left-0 -translate-x-[-62px] -translate-y-[-40px] select-none rounded-[10px] z-[20]"
                src="/images/fire.png"
                alt="Logo"
                width={40}
                height={40}
          ...
          >
            ...
            >
              <Image
                className="absolute top-0 left-0 -translate-x-[12px] -translate-y-[-60px] select-none rounded-[10px] z-[20]"
